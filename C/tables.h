...
void SetRedshift2WISWTable(float, float, double *);
...
void SetRedshift2TauTable(float, float, float, double *);
void SetRedshift2WTauTable(float, float, float, double *);
